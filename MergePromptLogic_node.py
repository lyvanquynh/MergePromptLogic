class MergePromptLogic:
    ...
    def INPUT_TYPES(s):
        return {
            "required": {
                ...
                "input_2": ("INT", {"default": 0, "min": 0, "max": 10000, "step": 1}),
                "input_3": ("INT", {"default": 0, "min": 0, "max": 10000, "step": 1}),
    ...
    def compare(self, input_1, input_2, input_3, comparison_value, comparison_type):
...
NODE_CLASS_MAPPINGS = {
    "MergePromptLogic": MergePromptLogic
}

# Human-readable name for the node
NODE_DISPLAY_NAME_MAPPINGS = {
    "MergePromptLogic": "Merge Prompt Logic"
}
